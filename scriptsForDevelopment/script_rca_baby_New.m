...
folders = dir('../Data/Baby_v2/Disparity/Inf*_Exp_TEXT*');
pathnames = {};
for k = 1:length(folders)
    pathnames{k} = ['../Data/Baby_v2/Disparity/' folders(k).name];
end
...
for fignum=1:5
    figure(fignum);
    print('-dpsc2','-append','../Data/Baby_v2/Disparity/RCA_Infants_2Hz_Disp.ps')
end