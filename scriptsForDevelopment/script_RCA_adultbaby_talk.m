...
hold on;
semilogx(binVals_AdDisp,noiseVals_AdDisp_norm(condNum,:,freqNum),'ks','LineWidth',1,'MarkerSize',12,'Color',adultColors(condNum,:),'MarkerFaceColor',adultColors(condNum,:))
...
freqNum = 2;
semilogx(binVals_InfDisp,ampVals_InfDisp_norm(condNum,:,freqNum),'-','LineWidth',3,'Color',infantColors(condNum,:))
semilogx(binVals_InfDisp,noiseVals_InfDisp_norm(condNum,:,freqNum),'ks','LineWidth',1,'MarkerSize',12,'Color',infantColors(condNum,:),'MarkerFaceColor',infantColors(condNum,:))
print -depsc2 FVM2015Figs/DispHor_InfAdults.eps

%% Plot threshold fits

freqNum = 1; % for adults
semilogx(threshInfo_AdDisp.xx{freqNum,condNum},threshInfo_AdDisp.YY{freqNum,condNum}./adultMax,'k-','LineWidth',3);
semilogx(threshInfo_AdDisp.threshVals(freqNum,condNum),0,'kd','MarkerSize',18,...
    'MarkerFaceColor',adultColors(condNum,:),'LineWidth',3);


freqNum = 2; % for infants
semilogx(threshInfo_InfDisp.xx{freqNum,condNum},threshInfo_InfDisp.YY{freqNum,condNum}./infMax,'k-','LineWidth',3);
