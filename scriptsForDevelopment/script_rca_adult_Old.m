...
dataLocation = '../Data/Pilot_3DThreshWithCorr/';
folders = dir([dataLocation,'S*_TEXT*c1c2']);
pathnames = {};
...
plotSettings.xTick = [0.5 2 4 8];%[0 0.5 1];
%figNum = plotRcData(rcaData,noiseData,rcaSettings,plotSettings,1);

%%
for fignum=1:5
    figure(fignum);
    print('-dpsc2','-append',[dataLocation,'RCANew_2Hz_c3c4.ps'])
end