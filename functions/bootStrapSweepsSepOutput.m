function [resampledVectAmplitudes,resampledSr,resampledSi] = bootStrapSweepsSepOutput(rawData,nBoot,nSubjsToAnalyze,condsToAnalyze,freqsToAnalyze,chansToAnalyze)
...
for condIx = condsToAnalyze
    ...
    for chanIx = chansToAnalyze
        ...
        for freqIx = freqsToAnalyze
            ...
            resampledVectAmplitudes(condIx,chanIx,freqIx,:,:) = ResampVectAmpl;
            resampledSr(condIx,chanIx,freqIx,:,:) = ResampVectSr;
            resampledSi(condIx,chanIx,freqIx,:,:) = ResampVectSi;
            %fprintf('\t\tdone.\n');
        end
        %fprintf('\tdone.\n');
    end
